    ...
    <>
      <div>
        <div className="w-full ">
          <div className="w-full ">
            <div className="flex  flex-col xl:flex-row-reverse items-start justify-between xl:h-[33vw]">
              {/* Right Section (Image) */}
              <div>
                <img src={home4} alt="" />
              </div>
              {/* Left Section (Text Content) */}
              <div className=" w-[100%] xl:w-[46.5%]  xl:pt-0 xl:ml-[120px]">
                <div className="mt-6 text-center xl:text-left xl:mt-25 lg:mt-20 xl:w-4/5 xl:p-12 xl:pl-0 xl:pb-0 ">
                  <p className=" text-2xl xl:text-[3vw] font-semibold whitespace-nowrap ">
                    Optimize. Secure. Simplify IT.
                  </p>
                  <p className="flex justify-center text-sm xl:text-lg text-secondary xl:pt-[2vw]  tracking-wide font-light ">
                ...
                <div className="flex flex-col xl:flex-col lg:flex-row items-center xl:items-start justify-center xl:justify-start mt-12 sm:flex-col">
                  <div className="relative flex justify-start items-start pl-5">
                    ...
                    <button className="bg-primary xl:ml-16 absolute xl:top-4 top-1/2 left-1/2 xl:left-0 -translate-x-1/2 -translate-y-1/2 xl:-translate-x-0 xl:-translate-y-0  text-white font-semibold py-3 px-6 xl:py-5 xl:px-10 rounded-full whitespace-nowrap">
                      Contact Now
                    </button>
                  </div>
                </div>
        ...
        <div className="flex flex-col xl:flex-row mt-12 xl:mt-28 justify-center items-center xl:justify-stretch xl:px-[120px]">
          <div className="mt-6 text-center xl:text-left ">
            <span className=" text-4xl xl:text-[3vw] font-bold whitespace-nowrap">
              Our Client
            </span>
            <span className="flex xl:pr-[10vw] text-base sm:text-lg text-tertiary tracking-wide font-light py-2 ">
          ...
          <div className="flex gap-[4vw]">
            <img
              src={google}
              alt=""
              className="size-16 xl:w-[10rem] xl:size-32 object-contain "
            />
            <img
              src={airbnb}
              alt=""
            ...
            <img
              src={amazon}
              alt=""
              className="size-16 xl:w-[10rem] xl:size-32 object-contain mt-2"
            />
          </div>
        </div>
      </div>
      ...
      <div className="text-center xl:px-24 xl:mt-12 mt-12 flex flex-col justify-around">
        <p className="text-2xl xl:text-[3vw] font-bold xl:px-3 leading-none">
      ...
      {/* next */}
      <div className="xl:px-24 xl:mt-12 flex flex-col xl:flex-row justify-between items-center">
        {/* First Column */}
      ...
      {/* next */}
      <div className="relative flex justify-center items-center xl:px-24 mt-12 p-6 mb-12">
          ...
          <div className="xl:relative flex items-center justify-center mt-4 xl:mt-0 xl:bg-primary xl:rounded-r-[200rem] xl:rounded-bl-[450rem] xl:rounded-tl-[200rem]  w-full xl:w-[40%] xl:h-full xl:px-4">
            <div className="relative w-full">
              <input
                ...
                className="xl:relative -left-24 px-6 py-3 xl:ml-8 xl:w-full h-16 text-gray-600 bg-white outline-none focus:ring-0 placeholder-gray-400 rounded-full shadow-md pr-28"
              />
              <button className="absolute right-2 top-2 xl:right-[4.5rem] xl:top-1/2 xl:transform xl:-translate-y-1/2 px-6 py-3 xl:px-6 xl:py-3 bg-primary text-white font-semibold rounded-full">
                Contact Now
              </button>
            </div>
          </div>
